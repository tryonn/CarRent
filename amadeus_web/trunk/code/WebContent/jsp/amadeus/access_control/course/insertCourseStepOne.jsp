...
<!-- 					<li><html:link forward="fCases"><bean:message key="institutionalLinks.cases"/></html:link></li>-->
		...
		<div id="side_menu">
		  ...
		  <div id="content">
			 <dl class="insert2">
				<html:form action="/insertCourseStepOne" focus="name" onsubmit="return validateCourseForm(this);">
					...
					<dt><bean:message key="courseForm.objectives"/></dt>
						<dd class="field"><html:textarea property="objectives" styleClass="formfield" styleId="mail"/></dd>
						<dd class="description"><bean:message key="courseForm.courseObjectives"/></dd>
					<dt><bean:message key="courseForm.content"/></dt>
						<dd class="field"><html:textarea property="content" styleClass="formfield" styleId="username"/></dd>
						<dd class="description"><bean:message key="courseForm.courseContent"/></dd>
					<dt><bean:message key="courseForm.students"/></dt>
						<dd class="field"><html:text property="students" styleClass="formfield" styleId="password"/></dd>
