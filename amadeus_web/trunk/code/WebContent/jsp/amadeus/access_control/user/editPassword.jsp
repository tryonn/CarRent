...
<html:html>
	<head> 
		<title><bean:message key="editPassword.title"/></title>
...
<!-- 					<li><html:link forward="fCases"><bean:message key="institutionalLinks.cases"/></html:link></li>-->
		...
		<div id="breadcrumbs">
			...
			<div id="content">
				<dl class="insert2">
					<html:errors/>
					<html:form action="/editPassword" focus="username" onsubmit="return validateEditPasswordForm(this);">
					<dt><bean:message key="editPassword.currentPassword"/></dt>
						<dd><html:password property="currentPassword" styleClass="formfield2" styleId="username"/></dd>
						<dd class="description"><bean:message key="editPassword.currentPasswordDescription"/></dd>
					<dt><bean:message key="editPassword.newPassword"/></dt>	
						<dd><html:password property="newPassword" styleClass="formfield2" styleId="password"/>	
						<dd class="description"><bean:message key="editPassword.newPasswordDescription"/></dd>
					<dt><bean:message key="editPassword.newPasswordConfirmation"/></dt>	
						<dd><html:password property="newPasswordConfirmation" styleClass="formfield2" styleId="realname"/>
						<dd class="description"><bean:message key="editPassword.newPasswordConfirmationDescription"/></dd>
					<dt class="field"><html:submit styleClass="button"><bean:message key="editPassword.edit"/></html:submit></dt>
				</html:form>
			</dl>
	...
	<html:javascript formName="editPasswordForm"/>	
	</body>
</html:html>
